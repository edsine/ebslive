                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row text-sm">
                            ...
                            <div class="col-md-6 text-end">
                                <address>
                                    <strong>{{\Modules\Accounting\Models\Utility::getValByName('company_name')}} </strong><br>
                                    {{\Modules\Accounting\Models\Utility::getValByName('company_address')}} , {{\Modules\Accounting\Models\Utility::getValByName('company_city')}},<br>
                                    {{\Modules\Accounting\Models\Utility::getValByName('company_state')}}-{{\Modules\Accounting\Models\Utility::getValByName('company_zipcode')}}<br>
                            ...
                            <div class="table-responsive">
                                <table class="table table-md">
                                    ...
                                    @foreach ($payslipDetail['earning']['allowance'] as $allowance)
                                        @php
                                            $employess = \App\Models\User::find($allowance->employee_id);
                                    ...
                                    @foreach ($payslipDetail['earning']['commission'] as $commission)
                                        @php
                                            $employess = \App\Models\User::find($commission->employee_id);
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-md">
                                    ...
                                    @foreach ($payslipDetail['deduction']['loan'] as $loan)
                                        @php
                                            $employess = \App\Models\User::find($loan->employee_id);
                                    ...
                                    @foreach ($payslipDetail['deduction']['deduction'] as $deduction)
                                        @php
                                            $employess = \App\Models\User::find($deduction->employee_id);
