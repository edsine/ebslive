        ...
        <div class="col-xxl-6 col-sm-12">
            <div class="card">
                <div class="nk-ecwg nk-ecwg6">
                    <div class="card-inner" style="margin: 20px;">
                        ...
                        <div class="data">
                            <div class="data-group">
                                <div class="form-group">
                                    <label for="">Complete &#8358;20,000 registration fee payment for {{ $employer->contact_firstname . ' '.$employer->contact_surname }}</label>
                                    @php
