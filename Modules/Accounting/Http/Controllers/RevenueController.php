...
class RevenueController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        if(Auth::user()->can('create revenue'))
        {
            ...
            return view('accounting::revenue.create', compact('customers', 'categories', 'accounts'));
        }
        else
        {
...
//            }
    ...
    public function edit(Revenue $revenue)
    {
        if(Auth::user()->can('edit revenue'))
        {
            ...
            return view('accounting::revenue.edit', compact('customers', 'categories', 'accounts', 'revenue'));
        }
        else
        {
            return response()->json(['error' => __('Permission denied.')], 401);
