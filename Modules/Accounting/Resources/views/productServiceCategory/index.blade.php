                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td class="font-style">
                                        {{ __(\Modules\Accounting\Models\ProductServiceCategory::$catTypes[$category->type]) }}
                                    </td>
                                    ...
                                    <td class="Action">
                                        ...
                                        @can('edit constant category')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#" class="mx-3 btn1 btn-sm align-items-center" data-url="{{ route('product-category.edit',$category->id) }}" data-ajax-popup="true" data-title="{{__('Edit Product Category')}}" data-bs-toggle="tooltip" title="{{__('Create')}}" data-original-title="{{__('Edit')}}">
                                            ...
                                            @can('delete constant category')
                                                <div class="action-btn bg-danger ms-2">
                                                    ...
                                                    <a href="#" class="mx-3 btn1 btn-sm align-items-center bs-pass-para" data-bs-toggle="tooltip" title="{{__('Delete')}}" data-original-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$category->id}}').submit();">
