...
{{--    <meta name="url" content="{{ url('').'/'.config('chatify.path') }}" data-user="{{ Auth::user()->id }}">--}}
    ...
    <!-- Favicon icon -->
   {{--  <link rel="icon" href="{{ asset('new_assets/assets/images/favicon.svg') }}" type="image/x-icon"/> --}}

    <link rel="stylesheet" href="{{ asset('new_assets/assets/css/plugins/style.css') }}">
    <link rel="stylesheet" href="{{ asset('new_assets/assets/css/plugins/animate.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('new_assets/assets/css/customizer.css') }}">

    <link rel="stylesheet" href="{{ asset('new_assets/css/custom.css') }}" id="main-style-link">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-8 col-lg-5">
                        <div class="row justify-content-center mb-3">
                            <a class="navbar-brand" href="#" style="text-align: center;margin: auto;">
