                    ...
                    @foreach ($types as $type)
                        <tr>
                            ...
                            <td style="width: 120px">
                                {!! Form::open(['route' => ['supply.destroy', $type->id], 'method' => 'delete']) !!}
                                <div class='btn-group'>
                                    {{-- <a href="{{ route('roles.show', [$role->id]) }}" class='btn btn-default btn-xs'>
                                        <i class="far fa-eye"></i>
                                    </a> --}}
                                    <a href="{{ route('supply.edit', [$type->id]) }}" class='btn btn-default btn-xs'>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('supply.store')}}" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            <label>ZIP</label>
                            <input name="zip" type="number" id="zip" class=" form-control" required />
                        </div>
                        <div class="form-group">
                            <label>Country</label>
