                    ...
                    @foreach ($types as $type)
                        <tr>
                            ...
                            <td style="width: 120px">
                                {!! Form::open(['route' => ['assettype.destroy', $type->id], 'method' => 'delete']) !!}
                                <div class='btn-group'>
                                    {{-- <a href="{{ route('roles.show', [$role->id]) }}" class='btn btn-default btn-xs'>
                                        <i class="far fa-eye"></i>
                                    </a> --}}
                                    <a href="{{ route('assettype.edit', [$type->id]) }}" class='btn btn-default btn-xs'>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('assettype.store')}}" method="POST" enctype="multipart/form-data" >
                        @csrf
