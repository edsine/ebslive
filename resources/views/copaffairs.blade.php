	...
	<div class="col-xl-4">
		...
		<a href="#" class="card shadow bg-body hoverable card-xl-stretch mb-xl-8">
			...
			<div class="card-body">
				...
				<div class="fw-semibold text-gray-400" style="font-size:15px;">Total Staff Request For Introduction</div>
			</div>
			<!--end::Body-->
		</a>
	...
	<div class="col-xl-4">
		...
		<a href="#" class="card shadow bg-dark hoverable card-xl-stretch mb-xl-8">
			...
			<div class="card-body">
				...
				<div class="fw-semibold text-gray-100" style="font-size:15px;">New Staff Request For Introduction</div>
			</div>
			<!--end::Body-->
		</a>
		<!--end::Statistics Widget 5-->
	...
	<div class="col-xl-4">
		...
		<a href="#" class="card shadow bg-success hoverable card-xl-stretch mb-xl-8">
			...
			<div class="card-body">
				...
				<div class="fw-semibold text-white" style="font-size:15px;">Treated Staff Request For Introduction</div>
			</div>
			<!--end::Body-->
		</a>
		<!--end::Statistics Widget 5-->
...
<div class="row g-5 g-xl-8">
	...
	<div class="col-xl-6">
    <div id="myCalendar" class="card"></div>
</div>
