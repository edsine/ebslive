    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <div class="card  shadow bg-success card-xl-stretch mb-xl-8">
            ...
            <div class="card-body my-3">
                ...
                <a href="#" class="card-title fw-bold text-warning fs-5 mb-3 d-block">Commulative Amount Collected As Contribution</a>
                <div class="py-1">
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <div class="card  shadow bg-light-primary card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body my-3">
                ...
                <a href="#" class="card-title fw-bold text-primary fs-5 mb-3 d-block">Number Of Employee/People Sensitized</a>
                <div class="py-1">
...
<div class="card-body  pt-5">
  <span class="card-label fw-bold text-dark" > Total Amount Collected As Contribution(for the month Under Review)</span>
