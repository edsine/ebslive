									...
									<div class="col-xl-3">
										...
										<a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
											...
											<div class="card-body">
												...
												<!--end::Svg Icon-->
												<div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">87000</div>
												<div class="fw-bold text-gray-100">Total Departments</div>
											</div>
											<!--end::Body-->
										</a>
										<!--end::Statistics Widget 5-->
									...
									<div class="col-xl-3">
										...
										<a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
											...
											<div class="card-body">
												...
												<div class="fw-bold text-white">Total Units</div>
											</div>
											<!--end::Body-->
										</a>
										<!--end::Statistics Widget 5-->
									...
									<div class="col-xl-3">
										...
										<a href="#" class="card bg-success hoverable card-xl-stretch mb-xl-8">
											...
											<div class="card-body">
												...
												<!--end::Svg Icon-->
												<div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">34</div>
												<div class="fw-bold text-gray-100">Total Regions</div>
											</div>
											<!--end::Body-->
										</a>
										<!--end::Statistics Widget 5-->
