            ...
            <div class="row g-5 g-xl-8">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="shadow card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body p-0">
                            <!--begin::Chart-->
                            <div class="mixed-widget-2-chart card-rounded-bottom bg-dark" data-kt-color="info"
                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <!--end::Svg Icon-->
                                        <a href="#" class="text-warning fw-semibold fs-6">Total:
                                            {{ $totalemployers }}</a>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                ...
                <div class="col-xl-4">
                    ...
                    <div class="shadow card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body p-0">
                            <!--begin::Chart-->
                            <div class="mixed-widget-2-chart card-rounded-bottom bg-white" data-kt-color="white"
                                style="height: 200px"></div>
                            <!--end::Chart-->
                            <!--begin::Stats-->
                            <div class="card-p mt-n20 position-relative">
                ...
                <!--end::Svg Icon-->2.2%</span> --}}
                        ...
                        <div class="card-body pt-2 pb-4 d-flex align-items-center">
                            ...
                            <div class="d-flex flex-center me-5 pt-2">
                                <div id="kt_card_widget_4_chart" style="min-width: 50%; min-height: 70px"
                    ...
                    <div class="card card-flush overflow-hidden h-md-100">
                        ...
                        <div class="card-header py-5">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-gray-400 mt-1 fw-semibold fs-6">Total number of Litigation per
                                    Month</span>
                            </h3>
                            <!--end::Title-->
                            <!--begin::Toolbar-->
                        ...
                        <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                            <!--begin::Chart-->
                            <div id="kt_charts_widget_32_chart_1" class="min-h-auto ps-4 pe-6" style="height: 300px">
                            </div>
                            <!--end::Chart-->
                        </div>
                        <!--end::Card body-->
