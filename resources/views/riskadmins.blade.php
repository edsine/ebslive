...
<div class="container">
    <a href="" class="btn btn-success">LOG IN TO ARM</a>
</div>
<!--begin::Row-->
                ...
                <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1" style="margin-top: -100px">
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="d-flex align-items-center flex-wrap w-100">
                            <!--begin::Title-->
                            <div class="mb-1 pe-3 flex-grow-1">
                                <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bolder">Pending Request</a>
                ...
                <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1" style="margin-top: -100px">
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="d-flex align-items-center flex-wrap w-100">
                            <!--begin::Title-->
                            <div class="mb-1 pe-3 flex-grow-1">
                                <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bolder">Lost Of Productivity</a>
                                {{-- <div class="text-gray-400 fw-bold fs-7">80% Rate</div> --}}
                            </div>
                            <!--end::Title-->
                            <!--begin::Label-->
