...
@section('content')
    <div class="container">
      <div class="row">
        <div class="col-md-6">
            <h1>New Webmail Email Address & Password</h1>
            <p>Password must be a minimum of 12 characters including atleast a number and a symbol </p>
            @include('flash::message')
            <form method="post" action="{{ route('new.email.password') }}">
                @csrf
                <div class="form-group">
                    <label for="email">Email Address</label>
                    <input type="email" name="email" class="form-control" id="email" required>
                    <div id="" class="form-text" style="color:brown;font-weight: bolder"></div>
                </div>
                <div class="form-group">
