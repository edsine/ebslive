                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{auth()->user()->first_name}}</a>
                            <a href="#">
                        ...
                        <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                            ...
                            {{-- @php
                               dd(Auth::user()->staff->ranking->name);

                            @endphp --}}
                            
                            <!--end::Svg Icon--> 
                            @if (optional(Auth::user()->staff)->ranking)
                            {{ Auth::user()->staff->ranking->name }}
                        ...
                        @endif
                            ...
                            <!--end::Svg Icon--> {{ auth()->user()->roles->isNotEmpty() ? auth()->user()->roles->pluck('name')->first() : 'no role yet' }}</a>
                    ...
                    <div class="d-flex my-4">
                        ...
                        <!--begin::Menu-->
                        <div class="me-0">
                            {{-- atp please take note , i cancelled the 3 dot for the modaL Class --}}
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Svg Icon-->
                                    <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{date('H:i:s')}}" data-kt-countup-prefix="">0</div>
                                </div>
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">Total Number of hours Spent</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            <!--begin::Stat-->
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <!--end::Number-->
                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">Task Assigned</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            <!--begin::Stat-->
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <!--end::Number-->
                                <!--begin::Label-->
                                 <div class="fw-bold fs-6 text-gray-400">Task Completed</div>
                                <!--end::Label-->
                            </div> 
                            <!--end::Stat-->
                        </div>
...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-header cursor-pointer">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">Profile Page</h3>
        </div>
        <!--end::Card title-->
        <!--begin::Action-->
    ...
    <div class="card-body p-9">
        ...
        <div class="row mb-7">
            ...
            <!--begin::Col-->
            <div class="col-lg-8">
                <span class="fw-bolder fs-6 text-gray-800">{{auth()->user()->first_name .' '.auth()->user()->middle_name . ' ' . auth()->user()->last_name  }}</span>
            </div>
            <!--end::Col-->
        </div>
        ...
        <div class="row mb-10">
            ...
            <div class="card-footer px-5 my-1">
                <a href="{{ route('profile') }}" class="btn btn-success">Account Settings</a>
