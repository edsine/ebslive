            ...
            <div class="flex-grow-1">
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex my-4">
                        ...
                        <!--begin::Menu-->
                        <div class="me-0">
                            {{-- atp please take note , i cancelled the 3 dot for the modL Class --}}
                    ...
                    <div class="d-flex flex-column flex-grow-1 pe-8">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            {{-- <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3"> --}}
                                ...
                                <!--end::Number-->
                                <!--begin::Label-->
                                {{-- <div class="fw-bold fs-6 text-gray-400">Success Ratessssss</div>
                                <!--end::Label-->
                            </div> --}}
                            <!--end::Stat-->
                        {{-- </div> --}}
    ...
    <div class="card-body p-9">
        ...
        <div class="row mb-7">
            ...
            <div class="col-lg-8 d-flex align-items-center">
                <span class="fw-bolder fs-6 text-gray-800 me-2">{{auth()->user()->staff->phone }}</span>
        ...
        <div class="row mb-7">
            ...
            <!--begin::Col-->
            <div class="col-lg-8">
                <span class="fw-bolder fs-6 text-gray-800">{{auth()->user()->staff->gender}} </span>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">Alternative Email </label>
            <!--begin::Label-->
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{auth()->user()->staff->alternative_email}}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            ...
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{auth()->user()->staff->about_me}}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
