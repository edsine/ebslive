...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 text-center">
                    <img src="{{ asset('NSITF-logo.png') }}" style="height: 100px;"/>
                    <h2>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::open(['route' => 'incoming_store_now', 'enctype' => 'multipart/form-data']) !!}
            @csrf

            <div class="card-body">

                <div class="row">
                    @include('incoming_documents.area_office_fields')
