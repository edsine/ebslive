...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
								...
								<div class="col-xl-3">
										...
										<a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
											...
											<div class="card-body">
												...
												<!--end::Svg Icon-->
												<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{$totalbranch}}
                                    ...
                                    <div class="col-xl-3">
										...
										<a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
											...
											<div class="card-body" data-toggle="modal" data-target="#exampleModalCenterxxDEP">
												...
												<!--end::Svg Icon-->
												<div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{$totaldept}}</div>
                                   ...
                                   <center><h3 class="fw-bolder">Enforcement /Compliance
									</h3></center> 
        ...
        <div class="card  shadow bg-light-success card-xl-stretch mb-xl-8">
            ...
            <div class="card-body my-3">
                <span class="float-end">
                    <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">Total Employer Registee</div>
                </span>
                <a href="#" class="card-title fw-bold text-success fs-5 mb-3 d-block"></a>
    ...
    <div class="col-sm-6 col-xl-4" data-toggle="modal" data-target="#exampleModalCenterxxrevcerts">
        ...
        <div class="card  shadow bg-light-warning card-xl-stretch mb-xl-8">
            ...
            <div class="card-body my-3">
                <span class="float-end">
                    <div class="text-white fw-bold fs-2 mb-2 mt-5">Total Registered Employee</div>
                </span>
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <div class="card  shadow bg-light-primary card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body my-3">
                <span class="float-end">
                    <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">Total Certificate Generated</div>
                </span>
                <a href="#" class="card-title fw-bold text-primary fs-5 mb-3 d-block"></a>
                <div class="py-1">
                    <span class="text-dark fs-1 fw-bold me-2">0</span>
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <a href="#" class="card shadow bg-body hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <span class="float-end">
                    <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">Notification</div>
                </span>
                <!--end::Svg Icon-->
                <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5" id="incrementingNumberw">0</div>
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <a href="#" class="card shadow bg-light-success hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <span class="float-end">
                    <div class="text-dark fw-bold fs-2 mb-2 mt-5">Rehabitation</div>
                </span>
                <div class="text-gray-100 fw-bold fs-2 mb-2 mt-5" id="incrementingNumber">
</div>
                <div class="fw-semibold text-dark">0</div>
            </div>
            <!--end::Body-->
        </a>
        <!--end::Statistics Widget 5-->
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <a href="#" class="card shadow bg-success hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <span class="float-end">
                    <div class="text-white fw-bold fs-2 mb-2 mt-5">Prosthesis</div>
                </span>
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <a href="#" class="card shadow bg-body hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <span class="float-end">
                    <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">No of ICT Staff</div>
                </span>
                <!--end::Svg Icon-->
                <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5" id="incrementingNumberw">0</div>
                <div class="fw-semibold text-gray-400"></div>
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <a href="#" class="card shadow bg-light-success hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <span class="float-end">
                    <div class="text-dark fw-bold fs-2 mb-2 mt-5">No of Staff with WorkTool</div>
                </span>
                <div class="text-dark fw-bold fs-2 mb-2 mt-5" id="incrementingNumber">0
</div>
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <a href="#" class="card shadow bg-success hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <span class="float-end">
                    <div class="text-white fw-bold fs-2 mb-2 mt-5">No of ICT worktools</div>
                </span>
                <div class="text-white fw-bold fs-2 mb-2 mt-5">0
</div>
                <div class="fw-semibold text-white"></div>
...
{{-- 									
                                    ...
                                    <center><h3 class="fw-bolder">APRD
									</h3></center> 
									<!--begin::Col-->
									<div class="col-sm-6 col-xl-6">
										...
										<div class="card-body d-flex justify-content-between align-items-start flex-column">
												...
												<div class="d-flex flex-column my-7">
													...
													<!--begin::Follower-->
													<div class="m-0">
														<span class="fw-bold fs-6 text-gray-400">Contribution From Private Sector</span>
													</div>
													<!--end::Follower-->
												</div>
												<!--end::Section-->
									...
									<div class="col-sm-6 col-xl-6">
										...
										<div class="card-body d-flex justify-content-between align-items-start flex-column">
												...
												<div class="d-flex flex-column my-7">
													...
													<!--begin::Follower-->
													<div class="m-0">
														<span class="fw-bold fs-6 text-gray-400">Contribution from Public Sector</span>
													</div>
													<!--end::Follower-->
												</div>
												<!--end::Section-->
