...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
								...
								<div class="col-xl-3">
                                   ...
                                   <center><h3 class="fw-bolder">Human Resources
									</h3></center> 
        ...
        <div class="card  shadow bg-light-success card-xl-stretch mb-xl-8">
            ...
            <div class="card-body my-3">
                <span class="float-end">
                    <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">Approved Leaves</div>
                </span>
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <div class="card  shadow bg-light-primary card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body my-3">
                <span class="float-end">
                    <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">Leave Request</div>
                </span>
...
<center><h3 class="fw-bolder">GENERAL ADMIN
</h3></center> 
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <a href="#" class="card shadow bg-body hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <span class="float-end">
                    <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5">ID CARD REQUEST</div>
                </span>
                <!--end::Svg Icon-->
                <div class="text-gray-900 fw-bold fs-2 mb-2 mt-5" id="incrementingNumberw"></div>
                <div class="fw-semibold text-gray-400">0</div>
            </div>
            <!--end::Body-->
        </a>
        <!--end::Statistics Widget 5-->
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <a href="#" class="card shadow bg-light-success hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <span class="float-end">
                    <div class="text-dark fw-bold fs-2 mb-2 mt-5">View Vechicle Request</div>
                </span>
    ...
    <div class="col-sm-6 col-xl-4">
        ...
        <a href="#" class="card shadow bg-success hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <!--end::Svg Icon-->
                <span class="float-end">
                    <div class="text-white fw-bold fs-2 mb-2 mt-5">Accomadation File</div>
                </span>
