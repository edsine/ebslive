                    ...
                    <div class="card-body ">
                        ...
                        <div class="d-flex flex-center flex-column-fluid">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{ url('/login') }}" method="post">
                                ...
                                <div class="text-center mb-11">
                                    <a href="{{route('home')}}">
                                        <span class="app-brand-logo demo">
                                            <img src="{{asset('assets/media/logos/NSITF-Logo-login.png')}}" style="width:100px;">
                                        </span>
                                ...
                                <div class="text-center mb-11">
                                    <!--begin::Title-->
                                    <h5 class="fw-bolder mb-3 fs-3 text" style="text-align:center; font-weight:bold; line-height:1.4;">Nigeria Social Insurance Trust Fund Enterprise Business Suite (EBS)</h5>
                                    <!--end::Title-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group=-->
