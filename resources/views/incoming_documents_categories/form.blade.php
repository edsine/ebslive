            ...
            <div class="form-group">
                <div class="form-control-wrap">
                    ...
                    <input type="text" class="form-control form-control-xl form-control-outlined"
                        id="file_no" name="name" value="{{ old('name', $incoming_documents_category->name ?? '') }}" required readonly>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-4 col-10">
            <div class="form-group">
                <div class="form-control-wrap">
                    ...
                    <input type="text" class="form-control form-control-xl form-control-outlined"
                        id="description" name="description" value="{{old('description', $incoming_documents_category->description ?? '')}}" required>
