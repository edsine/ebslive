...
<!--End  Menu: Accounting Report -->
            ...
            <div class="menu-item main-menu-item">
                <a href="javascript:;" class="menu-link menu-toggle">
                    ...
                    <span class="menu-title">Inter Comm</span>
                    <span class="menu-arrow"></span>
                </a>
                <div class="menu-sub menu-sub-accordion menu-active-bg">
            ...
            <!--End Main Menu 6: Operational Tasks -->
            @include('accounting::layouts.menu')
            ...
            <div data-kt-menu-trigger="click" class="menu-item here menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a href="#" class="menu-link {{ Request::is('bank-account*') ? 'active' : '' }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a href="#" class="menu-link {{ Request::is('bank-transfer*') ? 'active' : '' }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
