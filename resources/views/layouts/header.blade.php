...
use Illuminate\Support\Facades\Auth;
     ...
     <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
         ...
         <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
             <a href="#" class="d-lg-none">
                 <img alt="Logo" src="{{asset('assets/media/logos/NSITF-logo.png')}}" class="h-30px" />
             </a>
         </div>
         <!--end::Mobile logo-->
 ...
 <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
     ...
     <div class="menu-sub menu-sub-dropdown w-175px py-4">
         <!--begin::Menu item-->
         <div class="menu-item px-3">
             <a href="{{ route('home') }}" class="menu-link d-flex px-5 active">
         ...
         <!--begin::Menu item-->
         <div class="menu-item px-3">
             <a href="{{ route('home') }}" class="menu-link d-flex px-5">
                 <span class="symbol symbol-20px me-4">
 ...
 <!--begin::Menu item-->
 <div class="menu-item px-5">
     <!-- <a href="{{ route('home') }}" class="menu-link px-5">Sign Out</a> -->
