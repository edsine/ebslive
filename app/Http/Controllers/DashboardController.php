...
use Modules\Accounting\Models\Pos;
use Modules\Accounting\Models\Tax;
use Modules\Accounting\Models\Bill;
use Modules\Accounting\Models\Deal;
use Modules\Accounting\Models\Goal;
use Modules\Accounting\Models\Lead;
use Modules\Accounting\Models\Stage;
use Modules\Accounting\Models\Expense;
use Modules\Accounting\Models\Invoice;
use Modules\Accounting\Models\Payment;
use Modules\Accounting\Models\Revenue;
use Modules\Accounting\Models\Utility;
use Modules\Accounting\Models\DealTask;
use Modules\Accounting\Models\Purchase;
use Modules\HumanResource\Models\Event;
use Modules\Accounting\Models\LeadStage;
           ...
           if(Auth::user()->type == 'client')
            ...
            else
            {
                if(\Auth::user()->can('show account dashboard'))
                {
                    ...
                    return view('accounting::dashboard.account-dashboard', $data);
    ...
    public function clientView()
    {
        ...
        if(Auth::check())
        {
            ...
            if(Auth::user()->type == 'client')
            {
                ...
                $taskData        = TaskStage::getChartData();
